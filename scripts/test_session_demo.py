...
if r.status_code == 201:
    ...
    print("   INFO - User already exists, will use existing user")
    PHONE = new_phone
    PASSWORD = new_password
else:
...
if r.status_code == 200:
    print("   SUCCESS! Web token2 still valid (multi-device works)")
else:
    print("   FAIL - Web token2 was kicked (should not happen)")
